 ...
 */
const styles = ({ size, elContainerSizeX, elContainerSizeY, elContainerCoOrdinates = { x: 0, y: 0 }, backgroundColor }) => react_native_1.StyleSheet.create({
    /**
     * Style for the main container of the component.
     */
    container: {
        width: size ? size : (0, functions_1.WP)('100'), // Width of the container
        height: size ? size : (0, functions_1.WP)('100'), // Height of the container
